...
The section that the page belongs to. This is used to group pages together in the navigation. Separate groups will have a link at the top of the sidebar which allows users to navigate to the first page in that section. Each section has separate sidebars for organization purposes.

Any pages not configured with a section will be included in the "main" section.
